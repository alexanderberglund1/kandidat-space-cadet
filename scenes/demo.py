...
class DemoScene:
    ...
    def draw(self, screen):
        ...
        status = [f"Zoom {self.zoom:.2f}   Follow {follow_text}"]
        controls = "Click planet to follow   Scroll zoom   RMB pan   F cycle follow   C center   T trails   L labels   TAB help   ESC menu"
        self.hud.draw(screen, "SOLAR SYSTEM", status, controls_line=controls)
